...
System.out.print("\t\t\t\t\t _______________________________________________________________________________________ \n");
System.out.print("\n\n\t\t\t\t\t\t\t\t  E-HEALTH CARE MANAGEMENT SYSTEM         by UMARKHAN\n\n");	
System.out.print("\t\t\t\t\t _______________________________________________________________________________________ \n");
...
//getCurrentTimeUsingDate();  
        ...
        try {
            ...
            bufferedWriter.newLine();
            System.out.print("\nGender : ");gender=scan.next();bufferedWriter.write("Gender : "+gender);
            bufferedWriter.newLine();
    ...
    try {
        // FileReader reads text files in the default encoding.
            ...
            while((line = bufferedReader.readLine()) != null) 
            {
             ...
             System.out.print("\n\t\t\t\t\t\t ______________________HAVE A GOOD DAY_____________________________ \n");
            // Always close files.
            out.close();
            bufferedReader.close();         
        }
